...
function initShortQuestion() {
 qstHead[0]="Beispiel Sie möchten einen Regenschirm kaufen. Wohin gehen Sie? Erdgeschoss 1. Stock anderes Stockwerk    1 Sie möchten einen Film für Ihre Kamera kaufen.";
 qstHead[1]="2 Sie möchten einen Reiseführer über Berlin kaufen.";
 qstHead[2]="3 Sie haben gestern im Kaufhaus Ihre Geldbörse verloren";
 qstHead[3]="4 Sie möchten Seife kaufen.";
 qstHead[4]="5 Sie möchten eine Sonnenbrille kaufen.";
 qstHead[5]="Beispiel Peter Nohlen ist ein deutscher Pop-Musiker  Richtig    Falsch   ";
 qstHead[6]="Beispiel  Sie möchten den Rhein kennen lernen. Sie finden eine Reise mit dem Schiff ist da am besten.  Anzeige b    ";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(1,1,1,1,1,2,4);
