...
var qstHead;
var groups;
var quizTitle="horen A2 A2 deutsch pour tous et tous pour deutsch";
var printCpRg=1;
var filename = 'horen A2 A2';
...
function initShortQuestion() {
 qstHead[0]=" 1 Wo kann man noch parken?   ";
 qstHead[1]=" 2 Was soll Sabine nicht vergessen?";
 qstHead[2]=" 3 Wo findet das Treffen statt? ";
 qstHead[3]=" 4 Wie wird das Wetter am Sonntag?";
 qstHead[4]=" 5 Was sollen die Hörerinnen und Hörer tun?";
 qstHead[5]="Wählen Sie für die Aufgaben 6 bis 10 ein passendes Bild aus a bis i. Wählen Sie jeden Buchstaben nur einmal.    ";
 qstHead[6]="Markieren Sie für die Aufgaben 11 bis 15 die richtige Lösung a, b oder c.   11 Was hat das Mädchen gestern Abend gegessen?";
 qstHead[7]="Aufgabe 12 Für welches Kleidungsstück interessiert sich die Frau?";
 qstHead[8]="Aufgabe 13 Was fehlt für die Anmeldung?";
 qstHead[9]="14 Was ist kaputt?  ";
 qstHead[10]="15 Wohin soll der Mann gehen? ";
 qstHead[11]="Markieren Sie für die Aufgaben 16 bis 20 Ja oder Nein.   Beispiel 0  Sarah ist in Afrika geboren.   Ja     Nein";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(1,1,1,1,1,4,1,1,1,1,1,2);
