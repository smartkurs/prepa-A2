...
var qstHead;
var groups;
var quizTitle="horen A2 deutsch pour tous et tous pour deutsch";
var printCpRg=1;
var filename = 'horen A2';
...
function initShortQuestion() {
 qstHead[0]="  Beispiel  Werkstatt Auto fertig Zeit: ab 8.30 Uhr";
 qstHead[1]=" Beispiel Wie spät ist es gleich? a Acht Uhr am Abend. b Sechs Uhr am Abend. c Acht Uhr zehn am Abend.  6 Was kommt nachmittags um drei Uhr? ";
 qstHead[2]="7 Wie wird das Wetter morgen?";
 qstHead[3]="8 Wer oder was läuft auf der Straße?";
 qstHead[4]="9 Wer gratuliert zum Geburtstag?";
 qstHead[5]="10 Was kann man gewinnen?";
 qstHead[6]="Beispiel  Wo findet man diese Personen?  Person Chef Lösung a     a  Im ersten Stock.                               b Gegenüber dem Chefbüro.  c Am Empfang.                               d  Neben der Teeküche.  e  Im Kopierraum.                               f  In der Werkstatt.  g Über dem Computerraum.                              h  Im Keller.   i Im Schreibbüro.";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(4,1,1,1,1,1,4);
