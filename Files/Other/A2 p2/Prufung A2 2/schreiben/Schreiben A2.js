...
var qstHead;
var groups;
var quizTitle="Schreiben A2 deutsch pour tous et tous pour deutsch";
var printCpRg=1;
var filename = 'Schreiben A2';
...
function initShortQuestion() {
 qstHead[0]="Schreiben Sie die fünf fehlenden Informationen über Miguel in das Formular.    ";
 qstHead[1]="Hier finden Sie vier Punkte. Wählen Sie drei aus. Schreiben Sie zu jedem dieser drei Punkte ein bis zwei Sätze auf den Antwortbogen (circa 40 Wörter). Vergessen Sie nicht den passenden Anfang und Gruß am Schluss.     Beispiel:   ";
}
